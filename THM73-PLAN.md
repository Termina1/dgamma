...
|---|---|---|---|
| **O1** | External/replay/endpoint/generation and coherent occurrence algebra. | **2 holes; endpoint laws and external transitivity proved.** | **L.** |
...
After grind shift 1's first three O1 proofs, **29 deliberate named research holes remain**:
...
No hole was moved or renamed; both `relationalReplayEndpoint...Spike` bodies and
`sameExternalOrchestrationTransitiveSpike` were filled in place.

Forward/reverse map:

- O1=2, O2=2, O3=1, O4=2, O5=1, O6=3;
- O7=1, O8=1, O9=2, O10=1, O11=1, O12=1;
- O13=0, O14=1, O15=1, O16=1, O17=1, O18=1;
- O19=2, O20=1, O21=3, O22=0, O23=0.

The values sum to 29.
...
| 7 | Reconcile/estimate/path coherence | 29 holes remain; 148–257 original budget; per-derivation authority rationale explicit. |
