...
0 o19ActualUntouchedAfterCounts :
  ...
  (untouched : LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected source) ->
  (ordered : BlockBefore name key world error value nameEq keyEq source (actorRight swap) selected (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) untouched) ->
  (transitionCount (traceBeforeBlock (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique selected untouched ordered)) = transitionCount (traceBeforeBlock untouched),
   (transitionCount (actorBlockTrace (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique selected untouched ordered)) = transitionCount (actorBlockTrace untouched),
    transitionCount (prefixThroughBlock (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique selected untouched ordered)) = transitionCount (prefixThroughBlock untouched)))
o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique selected untouched ordered =
  o19PreserveAbsoluteCounts untouched (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique selected untouched ordered) ((o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (betweenBlocks ordered)))))
    (o19LocatedByWordCounts nameEq keyEq selected source untouched (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique)))
    (replayAligned (cursorBundle (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))))
    (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique selected (blockActiveAtFinal untouched))
...
0 o19ActualMovedAbsoluteCounts :
  ...
  (safety : AdjacentActorSwapSafety name key world error value protocol nameEq keyEq swap source blocks premises) ->
  (unique : UniqueRawNameInsertions name key world error value nameEq keyEq source) ->
  (transitionCount (traceBeforeBlock (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique)) = (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))),
   (transitionCount (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique)) = (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
    (LTE (transitionCount (prefixThroughBlock (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique))) (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
     transitionCount (prefixThroughBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique)) = (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))
o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique =
  ((cong transitionCount (fst (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique))), ((trans (sym (o19ActionWordLength (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique))))
    (trans (cong length (fst (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique))))
      (trans (o19ListLengthAppend (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))
        (cong2 (+) (o19ActionWordLength (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))), ((replace {p = \count => LTE count (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))} (sym (trans (o19PrefixThroughCount (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique)) (cong2 (+) (cong transitionCount (fst (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique))) (trans (sym (o19ActionWordLength (actorBlockTrace (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique)))) (trans (cong length (fst (snd (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique))))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))))
...
0 o19ActualBeforeSiteOrder :
  ...
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique)))
    early late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique lateSite)
o19ActualBeforeSiteOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique earlyMember (O19SiteBefore lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember))) (decomposedBlocksFollowOrder blocks late (actorLeft swap) (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn late (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) lateMember))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember)) (replace {p = BeforeIn early late} (sym (actorBeforeExact swap)) (o19BeforeChangeSuffix (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap)) (replace {p = UniqueKeys} (actorAfterExact swap) (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique)) lateMember (replace {p = BeforeIn early late} (actorAfterExact swap) ordered))))))
o19ActualBeforeSiteOrder {early} nameEq keyEq protocol swap source blocks premises safety unique earlyMember O19SiteRight ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight)
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique)))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))
o19ActualBeforeSiteOrder {early} nameEq keyEq protocol swap source blocks premises safety unique earlyMember O19SiteLeft ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft)
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique))))) (transitive (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))) (lteAddRight (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))))
o19ActualBeforeSiteOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique earlyMember (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn early late} (sym (actorBeforeExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap)) earlyMember (There (There lateMember)))))))
...
0 o19ActualRightSiteOrder :
  ...
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique)))
    (actorRight swap) late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique lateSite)
o19ActualRightSiteOrder {late} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn late (actorRight swap)} (sym (actorAfterExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorRight swap) ((actorLeft swap) :: (actorSuffix swap)) lateMember)))
o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight ordered = void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered ordered)
o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft ordered = o19ActualMovedBlocksOrdered nameEq keyEq protocol swap source blocks premises safety unique
o19ActualRightSiteOrder {late} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter lateMember))
    (replace {p = LTE (transitionCount (prefixThroughBlock (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight)))} (sym (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember)))))))) (transitive (fst (snd (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique)))) (o19OrderedBoundaryLTE source (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))
...
0 o19ActualSitesFollowOrder :
  ...
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique)))
    early late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique earlySite) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique lateSite)
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique (O19SiteBefore earlyMember) lateSite ordered = o19ActualBeforeSiteOrder nameEq keyEq protocol swap source blocks premises safety unique earlyMember lateSite ordered
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique O19SiteRight lateSite ordered = o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique lateSite ordered
o19ActualSitesFollowOrder {late} nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn late (actorLeft swap)} (sym (actorAfterExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) lateMember (There Here))))
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft O19SiteRight ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn (actorRight swap) (actorLeft swap)} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeHere Here))))
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft O19SiteLeft ordered = void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered ordered)
o19ActualSitesFollowOrder {late} nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique O19SiteLeft) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique)))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember)))))))
o19ActualSitesFollowOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter earlyMember) (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn late early} (sym (actorAfterExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) lateMember (There (There earlyMember)))))
o19ActualSitesFollowOrder {early} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter earlyMember) O19SiteRight ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn (actorRight swap) early} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeHere (There earlyMember)))))
o19ActualSitesFollowOrder {early} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter earlyMember) O19SiteLeft ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique) ordered (replace {p = BeforeIn (actorLeft swap) early} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere earlyMember)))))
o19ActualSitesFollowOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter earlyMember) (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) early (safetyRightInOrder safety) (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember)))) (replace {p = BeforeIn (actorRight swap) early} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere earlyMember)))))))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember))))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember)))) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn early late} (sym (trans (actorBeforeExact swap) (appendAssociative (actorPrefix swap) [(actorLeft swap), (actorRight swap)] (actorSuffix swap)))) (o19BeforeChangePrefix ((actorPrefix swap) ++ [(actorRight swap), (actorLeft swap)]) ((actorPrefix swap) ++ [(actorLeft swap), (actorRight swap)]) (actorSuffix swap) (replace {p = UniqueKeys} (trans (actorAfterExact swap) (appendAssociative (actorPrefix swap) [(actorRight swap), (actorLeft swap)] (actorSuffix swap))) (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique)) earlyMember (replace {p = BeforeIn early late} (trans (actorAfterExact swap) (appendAssociative (actorPrefix swap) [(actorRight swap), (actorLeft swap)] (actorSuffix swap))) ordered))))))
...
0 o19ActualTargetBlocksFollowOrder :
  ...
  BeforeIn early late targetOrder ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique)))
    early late (o19ActualTargetBlock nameEq keyEq protocol swap source blocks premises safety unique early earlyIn) (o19ActualTargetBlock nameEq keyEq protocol swap source blocks premises safety unique late lateIn)
o19ActualTargetBlocksFollowOrder nameEq keyEq protocol swap source blocks premises safety unique early late earlyIn lateIn ordered =
  o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique
