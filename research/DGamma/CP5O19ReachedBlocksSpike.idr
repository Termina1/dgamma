...
||| R207: actual-run declarations below are LEGACY-RESTRICTED twins.
||| All decomposed source bodies must carry explicit LegacyActorOnly evidence;
||| generic untouched reconstruction additionally names its own source shape.
||| OPEN unconditional target obligations are stated at the end, not postulated.
...
0 o19ActualRightBeginRange :
  ...
  O19BeginRange name key world error value nameEq keyEq (actorRight swap)
    (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (blockBody (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  o19BeginRangeObserved nameEq keyEq (actorRight swap)
    (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (blockBody (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
    (fst (o19ColumnCutAligned (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))) (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))) (columnRightWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))
...
0 o19ActualLeftBeginRange :
  ...
  O19BeginRange name key world error value nameEq keyEq (actorLeft swap)
    (cutPrefix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActionWord (blockBody (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))
o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  o19BeginRangeObserved nameEq keyEq (actorLeft swap)
    (cutPrefix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActionWord (blockBody (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))
    (fst (snd (o19ColumnCutAligned (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))) (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))) (cutLeftWord (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
...
0 o19ActualMovedBodiesInstalled :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (InstalledTrace name key world error value nameEq keyEq (actorRight swap) (rangeBody (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)),
   InstalledTrace name key world error value nameEq keyEq (actorLeft swap) (rangeBody (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
o19ActualMovedBodiesInstalled nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  (o19BeginRangeInstalled nameEq keyEq (actorRight swap)
    (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (blockBody (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)
    (fst (o19NoUnloadAppendSplit (actorRight swap) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (snd (o19NoUnloadAppendSplit (actorRight swap) (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (appendTransitions (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
        (replace {p = NoParentUnload (actorRight swap)} (sym (columnDecomposition (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19NoUnloadFromOrigins (actorRight swap) source (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
          (\occurrence => replayActionOrigin (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))) occurrence)
   ...
   o19BeginRangeInstalled nameEq keyEq (actorLeft swap)
    (cutPrefix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActionWord (blockBody (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)
    (fst (o19NoUnloadAppendSplit (actorLeft swap) (cutPrefix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (cutSuffix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
      (replace {p = NoParentUnload (actorLeft swap)} (sym (cutDecomposition (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
        (snd (o19NoUnloadAppendSplit (actorLeft swap) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (snd (o19NoUnloadAppendSplit (actorLeft swap) (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (appendTransitions (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
        (replace {p = NoParentUnload (actorLeft swap)} (sym (columnDecomposition (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19NoUnloadFromOrigins (actorLeft swap) source (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
          (\occurrence => replayActionOrigin (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))) occurrence)
...
o19ActorOnlyPrependObserved selected forbidden step rest tail (BlockOwnLifecycle lifecycle owner) =
  LegacyActorStep step rest lifecycle (trans (o19TransitionActorOwner step) owner) tail
o19ActorOnlyPrependObserved selected forbidden step rest tail (BlockGenerated child component inserted safe) =
  LegacyActorYield step rest inserted tail
...
0 o19ActorOnlyFromWord :
  ...
  LegacyActorOnly selected trace
o19ActorOnlyFromWord selected forbidden NoTransitions observations = LegacyActorEnd
...
0 o19ActualFinalActive :
  ...
  (supportedActiveAt {name} {key} {value} {world} {error} @{nameEq} selected (cursorFinal (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) = True)
o19ActualFinalActive {sourceFinal} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected active =
  trans (sym (o19SupportedActiveObserved nameEq selected sourceFinal (cursorFinal (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (lookupFiber {name} {key} {value} {world} {error} @{nameEq} selected (registry sourceFinal))
    (lookupFiber {name} {key} {value} {world} {error} @{nameEq} selected (registry (cursorFinal (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))) Refl Refl
    (controlPointwise (replayedControls (o19FiniteEndpoint nameEq keyEq (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (replayFinalWellFormed premises))) selected))) active
...
o19OrderedBeforeWord {rightActor} leftBlock rightBlock ordered =
  o19SnocInjective (o19ActionWord (traceBeforeBlock rightBlock))
    ...
    (trans (sym (o19ActionWordAppend (traceBeforeBlock rightBlock) (MoreTransitions (beginTransition (blockOpening rightBlock)) NoTransitions)))
      (trans (cong o19ActionWord (trans (blocksOrderedInGlobal ordered)
        (cong (\leading => appendTransitions leading
          (appendTransitions (betweenBlocks ordered) (MoreTransitions (beginTransition (blockOpening rightBlock)) NoTransitions)))
          (sym (appendTransitionsAssociative (traceBeforeBlock leftBlock)
            (MoreTransitions (beginTransition (blockOpening leftBlock)) NoTransitions) (blockBody leftBlock))))))
...
0 o19ActualMovedOutsideLifecycle :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  ((NoLifecycleBy (actorRight swap) (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))), NoLifecycleBy (actorRight swap) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))),
   (NoLifecycleBy (actorLeft swap) (appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))), NoLifecycleBy (actorLeft swap) (cutSuffix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))))
o19ActualMovedOutsideLifecycle nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  ((fst (o19OrderedOuterNoLifecycle (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (safetyBlocksOrdered safety)),
    o19NoLifecycleFromWord (actorRight swap) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))
      (\action, member => o19ElemAppendCases (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
        (\inLeft => o19ForeignBlockWordNoLifecycle (actorDistinct swap)
          (o19OriginalBlockWord (actorLeft swap) (actorRight swap) (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (safetyLeftDoesNotGenerateRight safety) action inLeft))
        ...
        (replace {p = Elem action} (columnRestWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) member))),
   (o19NoLifecycleFromWord (actorLeft swap) (appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
      (\action, member => o19ElemAppendCases (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
        ...
        (\inRight => o19ForeignBlockWordNoLifecycle (\same => actorDistinct swap (sym same))
          (o19OriginalBlockWord (actorRight swap) (actorLeft swap) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)) (safetyRightDoesNotGenerateLeft safety) action
            (replace {p = Elem action} (columnRightWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) inRight)))
        (replace {p = Elem action} (o19ActionWordAppend (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) member)),
...
0 o19ActualMovedBodiesActorOnly :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (ActorLifecycleOnly nameEq (actorRight swap) (rangeBody (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)),
   ActorLifecycleOnly nameEq (actorLeft swap) (rangeBody (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
o19ActualMovedBodiesActorOnly nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  (ActorWithoutForcedRoots (rangeBody (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (o19LegacyActorCore nameEq (o19ActorOnlyFromWord (actorRight swap) (actorLeft swap) (rangeBody (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))
    (\action, member => o19OwnedSafeWord (actorRight swap) (actorLeft swap) (blockBody (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)) (safetyRightDoesNotGenerateLeft safety)
      action (replace {p = Elem action} (rangeBodyWord (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) member)))),
   ActorWithoutForcedRoots (rangeBody (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (o19LegacyActorCore nameEq (o19ActorOnlyFromWord (actorLeft swap) (actorRight swap) (rangeBody (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))
    (\action, member => o19OwnedSafeWord (actorLeft swap) (actorRight swap) (blockBody (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (safetyLeftDoesNotGenerateRight safety)
      action (replace {p = Elem action} (rangeBodyWord (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) member)))))
...
o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  MkLocatedOpenEpisodeBlock (blockPreStart (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (rangeStart (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (columnMiddle (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))
    (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (rangeOpening (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (rangeBody (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))
    (fst (o19ActualMovedBodiesInstalled nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (fst (o19ActualMovedBodiesActorOnly nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))
    (fst (fst (o19ActualMovedOutsideLifecycle nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))) (snd (fst (o19ActualMovedOutsideLifecycle nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (actorRight swap) (blockActiveAtFinal (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
    (trans (cong (\spine => appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (appendTransitions spine (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))) (rangeDecomposition (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
      (columnDecomposition (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
...
0 o19ActualLeftLocatedBlock :
  ...
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq (actorLeft swap)
    (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  MkLocatedOpenEpisodeBlock (columnMiddle (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (rangeStart (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (cutMiddle (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (rangeOpening (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (rangeBody (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))
    (snd (o19ActualMovedBodiesInstalled nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (snd (o19ActualMovedBodiesActorOnly nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (cutSuffix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (fst (snd (o19ActualMovedOutsideLifecycle nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))) (snd (snd (o19ActualMovedOutsideLifecycle nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (actorLeft swap) (blockActiveAtFinal (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))
    (trans (cong (\spine => appendTransitions (appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (appendTransitions spine (cutSuffix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))) (rangeDecomposition (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))
      (trans (appendTransitionsAssociative (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (appendTransitions (cutPrefix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (cutSuffix (o19ColumnLeftCut (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))))
...
0 o19ActualMovedBlocksOrdered :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (actorRight swap) (actorLeft swap) (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)
o19ActualMovedBlocksOrdered nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  MkBlockBefore NoTransitions
    (cong (\leading => appendTransitions leading
      (MoreTransitions (beginTransition (rangeOpening (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))) NoTransitions))
      (cong (appendTransitions (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))
        (sym (rangeDecomposition (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))))
...
0 o19ActorOnlySameWord :
  ...
  {sourceFirst, sourceLast, targetFirst, targetLast : SystemState name key value world error} ->
  (source : Transitions sourceFirst sourceLast) -> (target : Transitions targetFirst targetLast) ->
  LegacyActorOnly selected source -> (o19ActionWord target = o19ActionWord source) ->
  LegacyActorOnly selected target
o19ActorOnlySameWord selected _ NoTransitions LegacyActorEnd exact = LegacyActorEnd
o19ActorOnlySameWord selected _ (MoreTransitions step rest) LegacyActorEnd exact = void (uninhabited (cong length exact))
o19ActorOnlySameWord selected _ NoTransitions (LegacyActorStep step rest lifecycle owner tail) exact = void (uninhabited (cong length exact))
o19ActorOnlySameWord selected _ NoTransitions (LegacyActorYield step rest inserted tail) exact = void (uninhabited (cong length exact))
o19ActorOnlySameWord selected _ (MoreTransitions reached reachedRest) (LegacyActorStep step rest lifecycle owner tail) exact =
  LegacyActorStep reached reachedRest
...
o19ActorOnlySameWord selected _ (MoreTransitions reached reachedRest) (LegacyActorYield step rest inserted tail) exact =
  LegacyActorYield reached reachedRest (trans (fst (consInjective exact)) inserted)
    (o19ActorOnlySameWord selected rest reachedRest tail (snd (consInjective exact)))
...
0 o19LocatedFromActualSegments :
  ...
  (blockLegacy : LegacyActorOnly selected (blockBody block)) ->
...
o19LocatedFromActualSegments {before} {rangeEnd} nameEq keyEq selected source block blockLegacy target origins earlier middle later decomposition range noEarlier noLater active =
  MkLocatedOpenEpisodeBlock before (rangeStart range) rangeEnd earlier (rangeOpening range) (rangeBody range)
    ...
    (ActorWithoutForcedRoots (rangeBody range) (o19LegacyActorCore nameEq
      (o19ActorOnlySameWord selected (blockBody block) (rangeBody range) blockLegacy (rangeBodyWord range))))
...
0 o19LocatedFromWordCuts :
  ...
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected target
o19LocatedFromWordCuts nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut secondCut =
  o19LocatedFromActualSegments nameEq keyEq selected source block blockLegacy target origins
...
0 o19LocatedAfterFirstCut :
  ...
  (firstCut : O19WordCut name key world error value beforeWord (o19ActionWord (actorBlockTrace block) ++ afterWord) target) ->
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected target
o19LocatedAfterFirstCut nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut =
  o19LocatedFromWordCuts nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut
...
0 o19LocatedByWord :
  ...
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected target
o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement =
  o19LocatedAfterFirstCut nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater
...
0 o19ActualSwapWord :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (o19ActionWord (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) =
    o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))
o19ActualSwapWord nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  trans (sym (cong o19ActionWord (columnDecomposition (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (trans (o19ActionWordAppend (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (appendTransitions (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
      (cong (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ++)
        (trans (o19ActionWordAppend (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRest (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
          (cong2 (++) (columnRightWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))) (columnRestWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))))
...
o19UntouchedBeforePlacement nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched ordered =
  trans (o19ActualSwapWord nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)
...
o19UntouchedAfterPlacement nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched ordered =
  trans (o19ActualSwapWord nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)
...
0 o19ActualUntouchedBeforeBlock :
  ...
  (selected : name) ->
  (untouched : LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected source) ->
  (untouchedLegacy : LegacyActorOnly selected (blockBody untouched)) ->
  (ordered : BlockBefore name key world error value nameEq keyEq source selected (actorLeft swap) untouched (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ->
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered =
  o19LocatedByWord nameEq keyEq selected source untouched untouchedLegacy (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (replayAligned (cursorBundle (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (blockActiveAtFinal untouched))
    (o19ActionWord (traceBeforeBlock untouched)) ((o19ActionWord (betweenBlocks ordered)) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))
...
0 o19ActualUntouchedAfterBlock :
  ...
  (ordered : BlockBefore name key world error value nameEq keyEq source (actorRight swap) selected (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) untouched) ->
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered =
  o19LocatedByWord nameEq keyEq selected source untouched untouchedLegacy (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (replayAligned (cursorBundle (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (blockActiveAtFinal untouched))
...
0 o19ActualBlockAtSite :
  ...
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
o19ActualBlockAtSite {selected} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore member) =
  o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (decomposedBlock blocks selected (replace {p = Elem selected} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) member))) (legacyBlocks selected (replace {p = Elem selected} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) member)))
...
o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight = o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks
o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft = o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks
o19ActualBlockAtSite {selected} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter member) =
  o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (decomposedBlock blocks selected (replace {p = Elem selected} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There member))))) (legacyBlocks selected (replace {p = Elem selected} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There member)))))
...
0 o19ActualTargetBlock :
  ...
  LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
o19ActualTargetBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected member =
  o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks
...
o19BlockBeforeFromGap source leftBlock rightBlock gap =
  MkBlockBefore (prefixGapTrace gap)
    (trans (cong (\leading => appendTransitions leading (MoreTransitions (beginTransition (blockOpening rightBlock)) NoTransitions)) (sym (prefixGapExact gap)))
      (trans (appendTransitionsAssociative (prefixThroughBlock leftBlock) (prefixGapTrace gap)
        (MoreTransitions (beginTransition (blockOpening rightBlock)) NoTransitions))
      (cong (\leading => appendTransitions leading (appendTransitions (prefixGapTrace gap)
        (MoreTransitions (beginTransition (blockOpening rightBlock)) NoTransitions)))
        (appendTransitionsAssociative (traceBeforeBlock leftBlock)
          (MoreTransitions (beginTransition (blockOpening leftBlock)) NoTransitions) (blockBody leftBlock)))))
...
o19ActualTargetUnique {sourceOrder} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
...
0 o19LocatedFromSegmentsWords :
  ...
  (o19ActionWord (traceBeforeBlock (o19LocatedFromActualSegments nameEq keyEq selected source block blockLegacy target origins earlier middle later decomposition range noEarlier noLater active)) = o19ActionWord earlier,
   o19ActionWord (actorBlockTrace (o19LocatedFromActualSegments nameEq keyEq selected source block blockLegacy target origins earlier middle later decomposition range noEarlier noLater active)) = o19ActionWord (actorBlockTrace block))
o19LocatedFromSegmentsWords nameEq keyEq selected source block blockLegacy target origins earlier middle later decomposition range noEarlier noLater active = (Refl, cong (LBegin selected ::) (rangeBodyWord range))
...
0 o19LocatedFromWordCutsWords :
  ...
  (firstCut : O19WordCut name key world error value beforeWord (o19ActionWord (actorBlockTrace block) ++ afterWord) target) ->
  (secondCut : O19WordCut name key world error value (o19ActionWord (actorBlockTrace block)) afterWord (cutSuffix firstCut)) ->
  (o19ActionWord (traceBeforeBlock (o19LocatedFromWordCuts nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut secondCut)) = beforeWord,
   o19ActionWord (actorBlockTrace (o19LocatedFromWordCuts nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut secondCut)) = o19ActionWord (actorBlockTrace block))
o19LocatedFromWordCutsWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut secondCut =
  (trans (fst (o19LocatedFromSegmentsWords nameEq keyEq selected source block blockLegacy target origins
    (cutPrefix firstCut) (cutPrefix secondCut) (cutSuffix secondCut)
    (trans (cong (appendTransitions (cutPrefix firstCut)) (cutDecomposition secondCut)) (cutDecomposition firstCut))
    (o19BeginRangeObserved nameEq keyEq selected (cutPrefix secondCut) (o19ActionWord (blockBody block))
      (fst (alignedAppendSplit (cutPrefix secondCut) (cutSuffix secondCut)
   ...
   snd (o19LocatedFromSegmentsWords nameEq keyEq selected source block blockLegacy target origins
    (cutPrefix firstCut) (cutPrefix secondCut) (cutSuffix secondCut)
    (trans (cong (appendTransitions (cutPrefix firstCut)) (cutDecomposition secondCut)) (cutDecomposition firstCut))
    (o19BeginRangeObserved nameEq keyEq selected (cutPrefix secondCut) (o19ActionWord (blockBody block))
      (fst (alignedAppendSplit (cutPrefix secondCut) (cutSuffix secondCut)
...
0 o19LocatedAfterFirstCutWords :
  ...
  (noLater : (action : Action name key value world error) -> Elem action afterWord ->
    (isLifecycleAction action = True) -> Not (actionOwner action = selected)) ->
  (firstCut : O19WordCut name key world error value beforeWord (o19ActionWord (actorBlockTrace block) ++ afterWord) target) ->
  (o19ActionWord (traceBeforeBlock (o19LocatedAfterFirstCut nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut)) = beforeWord,
   o19ActionWord (actorBlockTrace (o19LocatedAfterFirstCut nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut)) = o19ActionWord (actorBlockTrace block))
o19LocatedAfterFirstCutWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut =
  o19LocatedFromWordCutsWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater firstCut
    (o19CutByWord (o19ActionWord (actorBlockTrace block)) afterWord (cutSuffix firstCut) (cutRightWord firstCut))
...
0 o19LocatedByWordWords :
  ...
  (o19ActionWord (traceBeforeBlock (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) = beforeWord,
   o19ActionWord (actorBlockTrace (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) = o19ActionWord (actorBlockTrace block))
o19LocatedByWordWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement =
  o19LocatedAfterFirstCutWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater
    (o19CutByWord beforeWord (o19ActionWord (actorBlockTrace block) ++ afterWord) target placement)
...
0 o19LocatedByWordCounts :
  ...
  (noLater : (action : Action name key value world error) -> Elem action afterWord ->
    (isLifecycleAction action = True) -> Not (actionOwner action = selected)) ->
  (placement : o19ActionWord target = beforeWord ++ (o19ActionWord (actorBlockTrace block) ++ afterWord)) ->
  (transitionCount (traceBeforeBlock (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) = length beforeWord,
   (transitionCount (actorBlockTrace (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) = transitionCount (actorBlockTrace block),
    transitionCount (prefixThroughBlock (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) = length beforeWord + transitionCount (actorBlockTrace block)))
o19LocatedByWordCounts nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement =
  ((trans (sym (o19ActionWordLength (traceBeforeBlock (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))) (cong length (fst (o19LocatedByWordWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))), ((trans (sym (o19ActionWordLength (actorBlockTrace (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))) (trans (cong length (snd (o19LocatedByWordWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement))) (o19ActionWordLength (actorBlockTrace block)))), (trans (o19PrefixThroughCount (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)) (cong2 (+) (trans (sym (o19ActionWordLength (traceBeforeBlock (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))) (cong length (fst (o19LocatedByWordWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))) (trans (sym (o19ActionWordLength (actorBlockTrace (o19LocatedByWord nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement)))) (trans (cong length (snd (o19LocatedByWordWords nameEq keyEq selected source block blockLegacy target aligned origins active beforeWord afterWord noEarlier noLater placement))) (o19ActionWordLength (actorBlockTrace block))))))))
...
0 o19ActualMovedBoundaryWords :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (traceBeforeBlock (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) = (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))),
   (o19ActionWord (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ++ (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
    (o19ActionWord (actorBlockTrace (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
     o19ActionWord (actorBlockTrace (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))))
o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  (Refl,
   (trans (o19ActionWordAppend (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) (columnRight (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
      (cong (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ++) (columnRightWord (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))),
    (cong (LBegin (actorRight swap) ::) (rangeBodyWord (o19ActualRightBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)),
     cong (LBegin (actorLeft swap) ::) (rangeBodyWord (o19ActualLeftBeginRange nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))))
...
0 o19ActualUntouchedBeforeCounts :
  ...
  (untouchedLegacy : LegacyActorOnly selected (blockBody untouched)) ->
  (ordered : BlockBefore name key world error value nameEq keyEq source selected (actorLeft swap) untouched (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))) ->
  (transitionCount (traceBeforeBlock (o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (traceBeforeBlock untouched),
   (transitionCount (actorBlockTrace (o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (actorBlockTrace untouched),
    transitionCount (prefixThroughBlock (o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (prefixThroughBlock untouched)))
o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered =
  o19PreserveAbsoluteCounts untouched (o19ActualUntouchedBeforeBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered) (o19ActionWord (traceBeforeBlock untouched))
    (o19LocatedByWordCounts nameEq keyEq selected source untouched untouchedLegacy (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (replayAligned (cursorBundle (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (blockActiveAtFinal untouched))
    (o19ActionWord (traceBeforeBlock untouched)) ((o19ActionWord (betweenBlocks ordered)) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))
      ...
      (o19ElemAppendCases (o19ActionWord (betweenBlocks ordered)) ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))))
        ...
        (\inRest => snd (o19ElemAppendInjections (o19ActionWord (betweenBlocks ordered)) ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))) (o19ElemAppendCases (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))
          ...
          (\inLeftSuffix => o19ElemAppendCases (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
            (\inLeft => (fst (o19ElemAppendInjections (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))) inLeft))
            (\inSuffix => (snd (o19ElemAppendInjections (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))) (replace {p = Elem action} (sym (o19OrderedAfterWord (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (safetyBlocksOrdered safety))) (snd (o19ElemAppendInjections (o19ActionWord (betweenBlocks (safetyBlocksOrdered safety))) ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))) (snd (o19ElemAppendInjections (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (traceAfterBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))) inSuffix))))) inLeftSuffix) inRest)) member)))
    (o19UntouchedBeforePlacement nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched ordered)) (o19ActionWordLength (traceBeforeBlock untouched))

||| ACTUAL after-pair untouched start, whole-block size AND end are unchanged.
||| The absolute start is PROVED by original adjacent-gap evidence and owned
||| word-count commutation; source bounds are never asserted of arbitrary targets.
export
0 o19ActualUntouchedAfterCounts :
  {name, key, world, error : Type} -> {value : key -> Type} ->
  (nameEq : DecEq name) -> (keyEq : DecEq key) -> (protocol : RegistrationProtocol key value world error) ->
  {sourceOrder, targetOrder : List name} -> (swap : AdjacentActorOrderSwap name sourceOrder targetOrder) ->
  {initial, sourceFinal : SystemState name key value world error} -> (source : Transitions initial sourceFinal) ->
  ...
  (untouchedLegacy : LegacyActorOnly selected (blockBody untouched)) ->
  (ordered : BlockBefore name key world error value nameEq keyEq source (actorRight swap) selected (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) untouched) ->
  (transitionCount (traceBeforeBlock (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (traceBeforeBlock untouched),
   (transitionCount (actorBlockTrace (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (actorBlockTrace untouched),
    transitionCount (prefixThroughBlock (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered)) = transitionCount (prefixThroughBlock untouched)))
o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered =
  o19PreserveAbsoluteCounts untouched (o19ActualUntouchedAfterBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched untouchedLegacy ordered) ((o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) ++ ((o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ++ (o19ActionWord (betweenBlocks ordered)))))
    (o19LocatedByWordCounts nameEq keyEq selected source untouched untouchedLegacy (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (replayAligned (cursorBundle (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (finiteDerivationOccurrenceCorrespondence (cursorDerivation (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))))
    (o19ActualFinalActive nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected (blockActiveAtFinal untouched))
    ...
    (o19NoLifecycleWordMember selected (traceAfterBlock untouched) (noLaterLifecycle untouched))
    (o19UntouchedAfterPlacement nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks selected untouched ordered))
    (trans (o19ListSwapLength (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (betweenBlocks ordered))) (trans (cong2 (+) (cong2 (+) (cong2 (+) (o19ActionWordLength (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))
      (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActionWordLength (betweenBlocks ordered))) (sym (trans (o19OrderedBeforeCount source (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) untouched ordered)
      (cong (\count => count + transitionCount (betweenBlocks ordered))
        (trans (o19PrefixThroughCount (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))
          (cong (\count => count + transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))
            (o19AdjacentBlockStartCount (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (safetyBlocksOrdered safety) (safetyBlocksAdjacent safety)))))))))

||| ACTUAL moved absolute boundaries. Right starts at original left; left
||| starts after moved right. Right ends no later than original right end;
||| moved left ends EXACTLY at that original ordinal. All inequalities derived.
export
0 o19ActualMovedAbsoluteCounts :
  {name, key, world, error : Type} -> {value : key -> Type} ->
  (nameEq : DecEq name) -> (keyEq : DecEq key) -> (protocol : RegistrationProtocol key value world error) ->
  {sourceOrder, targetOrder : List name} -> (swap : AdjacentActorOrderSwap name sourceOrder targetOrder) ->
  {initial, sourceFinal : SystemState name key value world error} -> (source : Transitions initial sourceFinal) ->
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (transitionCount (traceBeforeBlock (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))),
   (transitionCount (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
    (LTE (transitionCount (prefixThroughBlock (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))) (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))),
     transitionCount (prefixThroughBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) = (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))
o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks =
  ((cong transitionCount (fst (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))), ((trans (sym (o19ActionWordLength (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))
    (trans (cong length (fst (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))
      (trans (o19ListLengthAppend (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))
        (cong2 (+) (o19ActionWordLength (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))), ((replace {p = \count => LTE count (transitionCount (prefixThroughBlock (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))} (sym (trans (o19PrefixThroughCount (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (cong2 (+) (cong transitionCount (fst (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))) (trans (sym (o19ActionWordLength (actorBlockTrace (o19ActualRightLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))) (trans (cong length (fst (snd (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))))
    (replace {p = LTE ((transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))} (sym (trans (o19PrefixThroughCount (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))) (cong (\count => count + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))) (o19AdjacentBlockStartCount (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (safetyBlocksOrdered safety) (safetyBlocksAdjacent safety)))))
      (plusLteMonotoneRight (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) ((transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))) (lteAddRight (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))))), (trans (o19PrefixThroughCount (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) (trans (cong2 (+) (trans (sym (o19ActionWordLength (traceBeforeBlock (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))
    (trans (cong length (fst (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))
      (trans (o19ListLengthAppend (o19ActionWord (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWord (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))
        (cong2 (+) (o19ActionWordLength (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))))))) (trans (sym (o19ActionWordLength (actorBlockTrace (o19ActualLeftLocatedBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))) (trans (cong length (snd (snd (snd (o19ActualMovedBoundaryWords nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))) (o19ActionWordLength (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety))))))) (trans (trans (sym (plusAssociative (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (transitionCount (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))) (trans (cong ((transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) +) (plusCommutative (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)))) (transitionCount (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))) (plusAssociative (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (transitionCount (actorBlockTrace (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))) (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))))) (sym (trans (o19PrefixThroughCount (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))) (cong (\count => count + (transitionCount (actorBlockTrace (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety))))) (o19AdjacentBlockStartCount (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (safetyBlocksOrdered safety) (safetyBlocksAdjacent safety)))))))))))

||| Actual unique finite order is asymmetric, including equal-name cases.
export
0 o19BeforeAsymmetric : {name : Type} -> {left, right : name} -> {order : List name} ->
  UniqueKeys order -> BeforeIn left right order -> Not (BeforeIn right left order)
o19BeforeAsymmetric (UniqueCons absent unique) (BeforeHere later) (BeforeHere earlier) = absent later
...
0 o19ActualBeforeSiteOrder :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  {early, late : name} -> (earlyMember : Elem early (actorPrefix swap)) ->
  (lateSite : O19SwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) late) -> BeforeIn early late targetOrder ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    early late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks lateSite)
o19ActualBeforeSiteOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlyMember (O19SiteBefore lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (legacyBlocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember))) (legacyBlocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember))) (decomposedBlocksFollowOrder blocks late (actorLeft swap) (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn late (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) lateMember))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (replace {p = Elem late} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) lateMember)) (replace {p = BeforeIn early late} (sym (actorBeforeExact swap)) (o19BeforeChangeSuffix (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap)) (replace {p = UniqueKeys} (actorAfterExact swap) (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) lateMember (replace {p = BeforeIn early late} (actorAfterExact swap) ordered))))))
o19ActualBeforeSiteOrder {early} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlyMember O19SiteRight ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight)
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (legacyBlocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))
o19ActualBeforeSiteOrder {early} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlyMember O19SiteLeft ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft)
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (legacyBlocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks))))) (transitive (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))) (lteAddRight (transitionCount (traceBeforeBlock (decomposedBlock blocks (actorLeft swap) (safetyLeftInOrder safety)))))))
o19ActualBeforeSiteOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlyMember (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedBeforeCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (legacyBlocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlocksFollowOrder blocks early (actorLeft swap) (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (safetyLeftInOrder safety) (replace {p = BeforeIn early (actorLeft swap)} (sym (actorBeforeExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorLeft swap) ((actorRight swap) :: (actorSuffix swap)) earlyMember)))))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (legacyBlocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (fst (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) earlyMember)) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn early late} (sym (actorBeforeExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap)) earlyMember (There (There lateMember)))))))
...
0 o19ActualRightSiteOrder :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  {late : name} -> (lateSite : O19SwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) late) -> BeforeIn (actorRight swap) late targetOrder ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    (actorRight swap) late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks lateSite)
o19ActualRightSiteOrder {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn late (actorRight swap)} (sym (actorAfterExact swap)) (o19BeforeAppendedSelected (actorPrefix swap) (actorRight swap) ((actorLeft swap) :: (actorSuffix swap)) lateMember)))
o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight ordered = void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered ordered)
o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft ordered = o19ActualMovedBlocksOrdered nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks
o19ActualRightSiteOrder {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter lateMember))
    (replace {p = LTE (transitionCount (prefixThroughBlock (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight)))} (sym (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (legacyBlocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember)))))))) (transitive (fst (snd (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))) (o19OrderedBoundaryLTE source (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))
...
0 o19ActualSitesFollowOrder :
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  {early, late : name} -> (earlySite : O19SwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) early) -> (lateSite : O19SwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) late) ->
  BeforeIn early late targetOrder ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    early late (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlySite) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks lateSite)
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteBefore earlyMember) lateSite ordered = o19ActualBeforeSiteOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks earlyMember lateSite ordered
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteRight lateSite ordered = o19ActualRightSiteOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks lateSite ordered
o19ActualSitesFollowOrder {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn late (actorLeft swap)} (sym (actorAfterExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) lateMember (There Here))))
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft O19SiteRight ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn (actorRight swap) (actorLeft swap)} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeHere Here))))
o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft O19SiteLeft ordered = void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered ordered)
o19ActualSitesFollowOrder {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks O19SiteLeft) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (snd (o19ActualMovedAbsoluteCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (legacyBlocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks (actorRight swap) (safetyRightInOrder safety)) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember)))))))
o19ActualSitesFollowOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter earlyMember) (O19SiteBefore lateMember) ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn late early} (sym (actorAfterExact swap)) (o19BeforeAcrossAppend (actorPrefix swap) ((actorRight swap) :: (actorLeft swap) :: (actorSuffix swap)) lateMember (There (There earlyMember)))))
o19ActualSitesFollowOrder {early} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter earlyMember) O19SiteRight ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn (actorRight swap) early} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeHere (There earlyMember)))))
o19ActualSitesFollowOrder {early} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter earlyMember) O19SiteLeft ordered =
  void (o19BeforeAsymmetric (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks) ordered (replace {p = BeforeIn (actorLeft swap) early} (sym (actorAfterExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere earlyMember)))))
o19ActualSitesFollowOrder {early} {late} nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter earlyMember) (O19SiteAfter lateMember) ordered =
  o19BlockBeforeByCount (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety))))) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter earlyMember)) (o19ActualBlockAtSite nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks (O19SiteAfter lateMember))
    (replace {p = \ends => LTE (fst ends) (snd ends)} (sym (cong2 MkPair (snd (snd (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember))))) (legacyBlocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) early (safetyRightInOrder safety) (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember)))) (replace {p = BeforeIn (actorRight swap) early} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere earlyMember)))))))) (fst (o19ActualUntouchedAfterCounts nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (legacyBlocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks (actorRight swap) late (safetyRightInOrder safety) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn (actorRight swap) late} (sym (actorBeforeExact swap)) (o19BeforeInPrepend (actorPrefix swap) (BeforeThere (BeforeHere lateMember))))))))) (o19OrderedBoundaryLTE source (decomposedBlock blocks early (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember))))) (decomposedBlock blocks late (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember))))) (decomposedBlocksFollowOrder blocks early late (replace {p = Elem early} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There earlyMember)))) (replace {p = Elem late} (sym (actorBeforeExact swap)) (snd (o19ElemAppendInjections (actorPrefix swap) ((actorLeft swap) :: (actorRight swap) :: (actorSuffix swap))) (There (There lateMember)))) (replace {p = BeforeIn early late} (sym (trans (actorBeforeExact swap) (appendAssociative (actorPrefix swap) [(actorLeft swap), (actorRight swap)] (actorSuffix swap)))) (o19BeforeChangePrefix ((actorPrefix swap) ++ [(actorRight swap), (actorLeft swap)]) ((actorPrefix swap) ++ [(actorLeft swap), (actorRight swap)]) (actorSuffix swap) (replace {p = UniqueKeys} (trans (actorAfterExact swap) (appendAssociative (actorPrefix swap) [(actorRight swap), (actorLeft swap)] (actorSuffix swap))) (o19ActualTargetUnique nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks)) earlyMember (replace {p = BeforeIn early late} (trans (actorAfterExact swap) (appendAssociative (actorPrefix swap) [(actorRight swap), (actorLeft swap)] (actorSuffix swap))) ordered))))))
...
export
0 o19ActualTargetBlocksFollowOrder :
  {name, key, world, error : Type} -> {value : key -> Type} ->
  (nameEq : DecEq name) -> (keyEq : DecEq key) -> (protocol : RegistrationProtocol key value world error) ->
  {sourceOrder, targetOrder : List name} -> (swap : AdjacentActorOrderSwap name sourceOrder targetOrder) ->
  {initial, sourceFinal : SystemState name key value world error} -> (source : Transitions initial sourceFinal) ->
  ...
  (legacyBlocks : (selected : name) -> (member : Elem selected sourceOrder) ->
    LegacyActorOnly selected (blockBody (decomposedBlock blocks selected member))) ->
  (early, late : name) -> (earlyIn : Elem early targetOrder) -> (lateIn : Elem late targetOrder) ->
  BeforeIn early late targetOrder ->
  BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (o19CartesianActualBlocks nameEq keyEq protocol swap source blocks premises safety unique (legacyBlocks (actorLeft swap) (safetyLeftInOrder safety)) (legacyBlocks (actorRight swap) (safetyRightInOrder safety)))))
    early late (o19ActualTargetBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early earlyIn) (o19ActualTargetBlock nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks late lateIn)
o19ActualTargetBlocksFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks early late earlyIn lateIn ordered =
  o19ActualSitesFollowOrder nameEq keyEq protocol swap source blocks premises safety unique legacyBlocks
    (o19ClassifySwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) (replace {p = Elem early} (actorAfterExact swap) earlyIn))
    (o19ClassifySwapSite (actorPrefix swap) (actorLeft swap) (actorRight swap) (actorSuffix swap) (replace {p = Elem late} (actorAfterExact swap) lateIn)) ordered


||| OPEN: needs the expanded unconditional producer / the reached separation
||| theorem. TYPE ONLY; no value of this contract is constructed here. The
||| original target-selector and physical-order conclusions are preserved on
||| the SAME required expanded run. Metadata/forcing-reason transport is open.
public export
record O19ReachedUnconditionalObligation
  (name, key, world, error : Type) (value : key -> Type)
  ...
  (safety : AdjacentActorSwapSafety name key world error value protocol nameEq keyEq swap source blocks premises)
  (unique : UniqueRawNameInsertions name key world error value nameEq keyEq source)
  (expanded : O19WholeBlockUnconditionalObligation name key world error value nameEq keyEq protocol swap source blocks premises safety unique) where
  constructor MkO19ReachedUnconditionalObligation
  0 o19ActualTargetBlockObligation : (selected : name) -> Elem selected targetOrder ->
    LocatedOpenEpisodeBlock name key world error value nameEq keyEq selected (cursorTrace (columnCursor (expandedRun expanded)))
  0 o19ActualTargetBlocksFollowOrderObligation : (early, late : name) ->
    (earlyIn : Elem early targetOrder) -> (lateIn : Elem late targetOrder) -> BeforeIn early late targetOrder ->
    BlockBefore name key world error value nameEq keyEq (cursorTrace (columnCursor (expandedRun expanded))) early late
      (o19ActualTargetBlockObligation early earlyIn) (o19ActualTargetBlockObligation late lateIn)
