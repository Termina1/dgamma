...
- `DGamma.CP4DeletionFrameCore` and `DGamma.CP4DeletionFrame*`: relational
  ...
  O-Retire, O-Remove, L-Begin, explicit L-Divert, L-Leave, and complete
  L-Unload, plus saturated empty/nonempty L-Finish, L-Iter, and L-Raise frames;
  L-Advance dispatcher integration and effectful landing-L-Divert remain.
...
| Lem 72 | `ActionSubsequence`, `EpisodeDeletedActor`, `RegisteredNamesDuring`, `WithdrawnNameResult`, `DeletionResult`, `ActualEffectFrame`, `deletionTheorem` | **partial**: selected deletion is lifecycle-only; R-owned actions and relevant-time guards remain explicit; registered endpoints cover both vestigial/absent and already-absent/absent cases. Actual-forward effect soundness is proved for O-Insert/O-Retire/O-Remove/L-Begin/explicit L-Divert/L-Leave and complete L-Unload, with saturated empty/nonempty L-Finish, L-Iter, and L-Raise frames. L-Advance dispatcher integration, effectful landing-L-Divert, independence-driven control applicability, and deleted-trace assembly remain open. |
