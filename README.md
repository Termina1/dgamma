...
- `DGamma.CP4DeletionFrameCore` and `DGamma.CP4DeletionFrame*`: relational
  ...
  O-Retire, O-Remove, L-Begin, L-Divert, L-Leave, plus the saturated L-Raise
  branch; L-Iter/L-Finish/L-Unload and L-Raise dispatcher integration remain.
...
| Lem 72 | `ActionSubsequence`, `EpisodeDeletedActor`, `RegisteredNamesDuring`, `WithdrawnNameResult`, `DeletionResult`, `ActualEffectFrame`, `deletionTheorem` | **partial**: selected deletion is lifecycle-only; R-owned actions and relevant-time guards remain explicit; registered endpoints cover both vestigial/absent and already-absent/absent cases. Actual-forward effect soundness is proved for six complete evaluator tags (O-Insert/O-Retire/O-Remove/L-Begin/L-Divert/L-Leave) plus the saturated L-Raise branch; L-Iter/L-Finish/L-Unload, L-Raise dispatcher integration, independence-driven control applicability, and deleted-trace assembly remain open. |
