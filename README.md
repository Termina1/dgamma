...
- `DGamma.CP4DeletionGenerationChecks`,
  ...
  five-rule provider-evidence dispatcher. Deleted-R heads, selected close
  packaging, and the relational suffix fold remain.
