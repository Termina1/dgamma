...
- `DGamma.CP4DeletionGenerationChecks`,
  ...
  interface. The remaining applicability gap is construction of that interface
  from the Lemma-71 cross-boundary invariant. The located-episode splitter
