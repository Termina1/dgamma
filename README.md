...
- `DGamma.CP4DeletionControl*`: executable Lemma-57 control frames showing that
  ...
  cannot create children. `DGamma.CP4DeletionPlanBoundary` combines proved
  inactivity and scanner uniqueness, isolating only generation-indexed
  `CurrentRegisteredChildless` before the complete plan follows.
