...
| Thm 63 | `beginSatisfactionTheorem`, `unloadGuardTheorem`, `InstallationEvolution`, `extractSpanningClosedEpisode`, `ProviderContainsConsumer`, `orderingTheorem` | Equation 58, exhaustive episode-boundary classification, and aligned global provider-episode selection infrastructure proved; final resolution/value-constancy assembly remains in progress |
