...
- `DGamma.CP4DeletionFrameCore` and `DGamma.CP4DeletionFrame*`: relational
  ...
  O-Retire, O-Remove, L-Begin, L-Divert, and L-Leave; the four effectful
  L-Advance/L-Unload tag cases remain Step-4 work.
...
| Lem 72 | `ActionSubsequence`, `EpisodeDeletedActor`, `RegisteredNamesDuring`, `WithdrawnNameResult`, `DeletionResult`, `ActualEffectFrame`, `deletionTheorem` | **partial**: selected deletion is lifecycle-only; R-owned actions and relevant-time guards remain explicit; registered endpoints cover both vestigial/absent and already-absent/absent cases. Actual-forward effect soundness is proved for six of ten evaluator tags (O-Insert/O-Retire/O-Remove/L-Begin/L-Divert/L-Leave); L-Iter/L-Finish/L-Raise/L-Unload, independence-driven control applicability, and deleted-trace assembly remain open. |
