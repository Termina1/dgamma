...
Usage: python3 -I research-tests/run-r191-artifact-commit.py UNIT MESSAGE PATH...
"""
import datetime
import hashlib
import json
...
recordPath = pathlib.Path('/tmp/dgamma-r191')/(unit+'.json')
...
# Supervisor-ratified docs-only exception: these two exact root documents.
