#!/usr/bin/env python3
"""Read-only R184 source/cache/census gate; never compiles or deletes seeds."""
import datetime
import hashlib
import json
import pathlib
...
# The LocalDiamond source is byte-unchanged throughout R184; no TTC deletion.
...
out = pathlib.Path(sys.argv[1] if len(sys.argv)>1 else '/tmp/dgamma-r184/frozen.json')
