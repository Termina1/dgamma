...
Usage: python3 -I research-tests/run-l2r2-archive.py L2R2 986342303cce59c27c157867cfeb124d3147a9f0 FINAL_HEAD
...
assert shift=='L2R2' and start=='986342303cce59c27c157867cfeb124d3147a9f0'
...
for r in records:
    ...
    assert r['path'].startswith('research-tests/O6-L2R2-Sources/'), 'New lane-owned targets only'
    target = r['path']
