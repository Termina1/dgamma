#!/usr/bin/env python3
"""One serialized, seeded, fresh R187 check. Launch detached with python3 -I.
No TTC is deleted. JSON/log/source snapshots live under /tmp/dgamma-r187.
Usage: run-r187-check.py UNIT PATH [DIAGNOSTIC [SYMBOL]]; PATH=package for build.
"""
import datetime
import hashlib
import json
...
OUT = pathlib.Path('/tmp/dgamma-r187')
