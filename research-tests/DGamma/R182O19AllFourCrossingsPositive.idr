module DGamma.R182O19AllFourCrossingsPositive

import DGamma.R182O19FourCrossingsPositive
import DGamma.R182O19FourthCrossingConstruction
...
||| B39: NO INPUTS. All FOUR actual Cartesian crossings on A14's six-edge
||| source: Finish0/Begin1, Begin0/Begin1, Finish0/Finish1, Begin0/Finish1.
||| All four sealed results, real reached bundles, full source-to-final nonempty
||| derivation and original transported uniqueness are retained together.
||| NOT WholeBlockSwapDerivation: ranges/origin plan/generic loop remain open.
public export
0 r182ActualAllFourCrossings :
  ...
  (thirdDiamond : LocalRelationalDiamond Nat R45Key Unit String R45Value r45NameEq r45KeyEq (twoActionFirst observed) (twoActionSecond observed) **
   ...
   (fourthResult : AdjacentSwapResult Nat R45Key Unit String R45Value r45Protocol r45NameEq r45KeyEq (swappedTrace thirdResult)
    ...
    (NonEmptyFiniteAdjacentSwapDerivation Nat R45Key Unit String R45Value r45Protocol r45NameEq r45KeyEq (r182IndependentTrace False) (swappedTrace fourthResult),
     UniqueRawNameInsertions Nat R45Key Unit String R45Value r45NameEq r45KeyEq (swappedTrace fourthResult)))))))))))
r182ActualAllFourCrossings = r182FourCrossingsObserved r182ActualThirdCrossing
