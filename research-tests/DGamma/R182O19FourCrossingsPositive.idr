module DGamma.R182O19FourCrossingsPositive
...
||| B38: complete the FOUR-NODE concrete producer simultaneously. The
||| SAME third reached package supplies its current bundle and uniqueness;
||| the new sealed result joins the full source-to-current nonempty chain.
||| This is NOT a generic block/range/origin-plan theorem.
public export
0 r182FourCrossingsObserved :
...
r182FourCrossingsObserved
  (firstDiamond ** (firstResult ** (secondDiamond ** (secondResult **
    (observed ** (thirdDiamond ** (thirdResult ** (reachedDerivation, reachedUnique)))))))) =
  (firstDiamond ** (firstResult ** (secondDiamond ** (secondResult **
    (observed ** (thirdDiamond ** (thirdResult **
