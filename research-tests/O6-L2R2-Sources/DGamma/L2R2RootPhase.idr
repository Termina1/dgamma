...
0 beginSnapshotRootDecreases :
  ...
  rootBirthInversions prior
    (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep first (Fired {before = first} {afterState = middle} nameEq keyEq (LBegin actor) LBeginTag beforeBegin) (MoreTransitions (Fired {before = middle} {afterState = cut} nameEq keyEq (OInsert root Root component) OInsertTag beforeRoot) NoTransitions)
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep middle (Fired {before = middle} {afterState = cut} nameEq keyEq (OInsert root Root component) OInsertTag beforeRoot) NoTransitions (DGamma.CP5AvailabilityAwarePlacement.AvailabilityEnd cut))) =
  S (rootBirthInversions prior
    (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep first (Fired {before = first} {afterState = snapshotRootMiddle exchange} nameEq keyEq (OInsert root Root component) OInsertTag (snapshotRootEarly exchange)) (MoreTransitions (Fired {before = snapshotRootMiddle exchange} {afterState = snapshotRootFinal exchange} nameEq keyEq (LBegin actor) LBeginTag (snapshotRootLater exchange)) NoTransitions)
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (snapshotRootMiddle exchange) (Fired {before = snapshotRootMiddle exchange} {afterState = snapshotRootFinal exchange} nameEq keyEq (LBegin actor) LBeginTag (snapshotRootLater exchange)) NoTransitions (DGamma.CP5AvailabilityAwarePlacement.AvailabilityEnd (snapshotRootFinal exchange)))))
  ...
  0 rootPhaseMeasure : (prior : Nat) ->
    rootBirthInversions prior
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep first (Fired {before = first} {afterState = middle} nameEq keyEq (LBegin actor) LBeginTag beforeBegin) (MoreTransitions (Fired {before = middle} {afterState = cut} nameEq keyEq (OInsert root Root component) OInsertTag beforeRoot) NoTransitions)
        (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep middle (Fired {before = middle} {afterState = cut} nameEq keyEq (OInsert root Root component) OInsertTag beforeRoot) NoTransitions (DGamma.CP5AvailabilityAwarePlacement.AvailabilityEnd cut))) =
    S (rootBirthInversions prior
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep first (Fired {before = first} {afterState = snapshotRootMiddle rootPhaseSquare} nameEq keyEq (OInsert root Root component) OInsertTag (snapshotRootEarly rootPhaseSquare)) (MoreTransitions (Fired {before = snapshotRootMiddle rootPhaseSquare} {afterState = snapshotRootFinal rootPhaseSquare} nameEq keyEq (LBegin actor) LBeginTag (snapshotRootLater rootPhaseSquare)) NoTransitions)
        (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (snapshotRootMiddle rootPhaseSquare) (Fired {before = snapshotRootMiddle rootPhaseSquare} {afterState = snapshotRootFinal rootPhaseSquare} nameEq keyEq (LBegin actor) LBeginTag (snapshotRootLater rootPhaseSquare)) NoTransitions (DGamma.CP5AvailabilityAwarePlacement.AvailabilityEnd (snapshotRootFinal rootPhaseSquare)))))
...
record SmallRootPhaseEvidence where
  ...
  smallOriginalTrail : DGamma.CP5AvailabilityAwarePlacement.AvailabilityTrace Nat Bool Unit String (\key => Unit) smallOriginalRun
  smallMovedTrail : DGamma.CP5AvailabilityAwarePlacement.AvailabilityTrace Nat Bool Unit String (\key => Unit) (rootPhaseTrace smallPhase)
...
smallRootPhaseEvidence = MkSmallRootPhaseEvidence
  ...
  (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (smallState 0) (Fired {before = smallState 0} {afterState = smallState 1} %search %search (LBegin 0) LBeginTag (smallBegin0 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 1} {afterState = smallState 2} %search %search (LAdvance 0) LFinishTag (smallFinish0 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 2} {afterState = smallState 3} %search %search (ORetire 1) ORetireTag (smallRetire1 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 3} {afterState = smallState 4} %search %search (ORemove 1) ORemoveTag (smallRemove1 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 4} {afterState = smallState 8} %search %search (LBegin 2) LBeginTag (smallEarlyBegin2 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 8} {afterState = smallState 9} %search %search (OInsert 3 Root (smallComponent True)) OInsertTag (smallLateInsert3 smallNativeExecution)) NoTransitions)))))
      ...
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (smallState 4) (Fired {before = smallState 4} {afterState = smallState 8} %search %search (LBegin 2) LBeginTag (smallEarlyBegin2 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 8} {afterState = smallState 9} %search %search (OInsert 3 Root (smallComponent True)) OInsertTag (smallLateInsert3 smallNativeExecution)) NoTransitions)
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (smallState 8) (Fired {before = smallState 8} {afterState = smallState 9} %search %search (OInsert 3 Root (smallComponent True)) OInsertTag (smallLateInsert3 smallNativeExecution)) NoTransitions
  ...
  (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (smallState 0) (Fired {before = smallState 0} {afterState = smallState 1} %search %search (LBegin 0) LBeginTag (smallBegin0 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 1} {afterState = smallState 2} %search %search (LAdvance 0) LFinishTag (smallFinish0 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 2} {afterState = smallState 3} %search %search (ORetire 1) ORetireTag (smallRetire1 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 3} {afterState = smallState 4} %search %search (ORemove 1) ORemoveTag (smallRemove1 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 4} {afterState = smallState 5} %search %search (OInsert 3 Root (smallComponent True)) OInsertTag (smallInsert3 smallNativeExecution)) (MoreTransitions (Fired {before = smallState 5} {afterState = smallState 6} %search %search (LBegin 2) LBeginTag (smallBegin2 smallNativeExecution)) NoTransitions)))))
      ...
      (DGamma.CP5AvailabilityAwarePlacement.AvailabilityStep (smallState 5) (Fired {before = smallState 5} {afterState = smallState 6} %search %search (LBegin 2) LBeginTag (smallBegin2 smallNativeExecution)) NoTransitions
