#!/usr/bin/env python3
"""Read-only R198 exact whole-frozen-source/body/census/seed audit; no compiler."""
...
old_frozen=json.loads((ROOT/'research-tests/O6-R197-FROZEN-AUDIT.json').read_text())
...
assert changed, "R198 retained research modules required"
for p in changed:
