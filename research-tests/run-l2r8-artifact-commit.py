...
Accept lane-owned L2R8 non-Idris artifacts, the predecessor CP3 draft/manifest,
only. No predecessor runner repair or Idris
source/body/comment repair is authorized.
Usage: python3 -I research-tests/run-l2r8-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in {'research-tests/O6-L2R5-CP3-DIFF-DRAFT.md','research-tests/O6-L2R5-CP3-REHOME-MANIFEST.json'} or path in REPAIRS or path in HEADER_REPAIRS or (path.startswith(('research-tests/O6-L2R8-', 'research-tests/run-l2r8-')) and not path.endswith('.idr'))
