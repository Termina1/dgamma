...
Only lane-owned L2R5 non-Idris artifacts are accepted.
Usage: python3 -I research-tests/run-l2r5-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in REPAIRS or (path.startswith(('research-tests/O6-L2R5-', 'research-tests/run-l2r5-')) and not path.endswith('.idr'))
