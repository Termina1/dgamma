...
record FrontDispositionFixtures
  ...
  singleFrontTrail : DGamma.CP5AvailabilityAwarePlacement.AvailabilityTrace Nat Bool Unit String (\key => Unit) smallTrace
  barrierFrontTrail : DGamma.CP5AvailabilityAwarePlacement.AvailabilityTrace Nat Bool Unit String (\key => Unit) barrierTrace
  ...
  0 singleResidualNormalForm : DGamma.L2R3AttachedGap.AttachedNormalForm Nat Bool Unit String (\key => Unit) %search %search smallTrace singleGap 5
  0 barrierResidualNormalForm : DGamma.L2R3AttachedGap.AttachedNormalForm Nat Bool Unit String (\key => Unit) %search %search barrierTrace bundleGap 6
