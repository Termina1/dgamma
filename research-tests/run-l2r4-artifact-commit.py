...
Only lane-owned L2R4 non-Idris artifacts are accepted.
Usage: python3 -I research-tests/run-l2r4-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in REPAIRS or (path.startswith(('research-tests/O6-L2R4-', 'research-tests/run-l2r4-')) and not path.endswith('.idr'))
