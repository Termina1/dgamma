...
Accept lane-owned L2R11 non-Idris artifacts ONLY. No predecessor repairs.
Usage: python3 -I research-tests/run-l2r11-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in REPAIRS or (path.startswith(('research-tests/O6-L2R11-', 'research-tests/run-l2r11-')) and not path.endswith('.idr'))
