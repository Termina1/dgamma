#!/usr/bin/env python3
"""Read-only R190 source/cache/census gate; never compiles or deletes seeds."""
import datetime
import hashlib
import json
import pathlib
...
# R190 has no type rehome permission; all five entry modules and O19 Surface
...
# No LocalDiamond visibility change in R190; seeded TTC retained without deletion.
...
out = pathlib.Path(sys.argv[1] if len(sys.argv)>1 else '/tmp/dgamma-r190/frozen.json')
