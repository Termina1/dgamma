#!/usr/bin/env python3
"""Read-only R197 exact whole-frozen-source/body/census/seed audit; no compiler."""
import datetime, hashlib, json, pathlib, re, subprocess, sys
ROOT=pathlib.Path(__file__).resolve().parents[1]
START='e2ebe3b5c61f75dc760a72ede14ebaf426823ef7'
...
old_frozen=json.loads((ROOT/'research-tests/O6-R196-FROZEN-AUDIT.json').read_text())
...
assert record['retainedNewDeclarations']==33
