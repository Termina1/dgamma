#!/usr/bin/env python3
"""Independent, compiler-free L2R12 evidence validator. Imports NO check/commit
...
PREFIX='research-tests/O6-L2R12-'
RAW=Path('/tmp/dgamma-l2r12')
BASE='a23a6d54'
BOOTSTRAP='research-tests/O6-L2R11-Sources/DGamma/L2R11PhaseDecode.idr'
CAPS={'A':14,'B':14,'C':14,'D':8}
