#!/usr/bin/env python3
"""One serialized, seeded, fresh R186 check. Launch detached with python3 -I.
No TTC is deleted. JSON/log/source snapshots live under /tmp/dgamma-r186.
Usage: run-r186-check.py UNIT PATH [DIAGNOSTIC [SYMBOL]]; PATH=package for build.
"""
import datetime
import hashlib
import json
...
OUT = pathlib.Path('/tmp/dgamma-r186')
