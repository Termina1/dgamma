#!/usr/bin/env python3
"""Detached serial final validations from the immutable R189 plan.
...
compilers. R189 proof stop and all-start cutoff are enforced by the check runner.
"""
import datetime
import json
import pathlib
...
for item in plan:
    ...
    args = ['python3', '-I', str(ROOT/'research-tests/run-r189-check.py'), item['unit'], item['path']]
