#!/usr/bin/env python3
"""Authenticate R198 native lifetimes, actual shared-lock intervals and RSS limits."""
...
for r in records:
    ...
    assert a[0]['pid']==z[0]['owner']['pid'] and a[0]['lane']==z[0]['owner']['lane']=='R198-main'
...
assert not current or current.get('lane')!='R198-main'
