"""R208 main-lane frozen authentication and immutable evidence helpers."""
import datetime, hashlib, json, pathlib, re, subprocess, sys
sys.dont_write_bytecode = True
ROOT = pathlib.Path(__file__).resolve().parents[1]
OUT = pathlib.Path('/tmp/dgamma-r208')
START = 'c1f99b7a82d8046158f6459678e50494e26788bf'
...
def assert_frozen():
    ...
    assert not git('diff', START, '--', 'src/', 'dgamma.ipkg'), 'Production must remain byte-identical toc1f99b7a'
