...
OUT=Path('/tmp/dgamma-l2r12')
PLAN=ROOT/'research-tests/O6-L2R12-FINAL-VALIDATION-PLAN.json'
...
for task in plan['validations']:
 ...
 subprocess.run(['python3','-I',str(ROOT/'research-tests/run-l2r12-launch.py'),task['unit'],task['path']],cwd=ROOT,check=True)
