#!/usr/bin/env python3
"""Read-only R193 source/cache/census gate; never compiles or deletes seeds."""
import datetime
import hashlib
import json
import pathlib
...
# R193 has no type rehome permission; only the exact A11 field is revised.
...
# No LocalDiamond visibility change in R193; seeded TTC retained without deletion.
