...
Usage: python3 -I research-tests/run-r187-archive.py R186 aa8ef19e e535e361
...
for r in records:
    ...
    normalized.append(dict(invocation=r['unit'],unit=match[1] if match else r['unit'],attempt=int(match[2]) if match else None,
