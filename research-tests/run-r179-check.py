#!/usr/bin/env python3
"""One serialized, seeded, fresh R179 check. Launch detached with python3 -I.
No TTC is deleted. JSON/log/source snapshots live under /tmp/dgamma-r179.
Usage: run-r179-check.py UNIT PATH [DIAGNOSTIC [SYMBOL]]; PATH=package for build.
"""
import datetime
import hashlib
import json
...
with (OUT/(unit+'.log')).open('w') as log:
    ...
    while process.poll() is None:
        ...
        if maximum > 80*1024*1024 and not interrupted:
