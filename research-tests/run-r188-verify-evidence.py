#!/usr/bin/env python3
"""Compiler-free independent audit of R188 exact records/commit-time receipts.
Usage: python3 -I research-tests/run-r188-verify-evidence.py --expected-c N --expected-validations N
...
ledger = json.loads((ROOT/'research-tests/O6-R188-COMPILER-LEDGER.json').read_text())
assert ledger['shift'] == 'R188'
