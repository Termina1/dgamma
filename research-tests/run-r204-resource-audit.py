...
spec=importlib.util.spec_from_file_location('contract',ROOT/'research-tests/r204_evidence_contract.py');c=importlib.util.module_from_spec(spec);spec.loader.exec_module(c)
