...
Accept lane-owned L2R12 non-Idris artifacts ONLY. No predecessor repairs.
Usage: python3 -I research-tests/run-l2r12-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in REPAIRS or (path.startswith(('research-tests/O6-L2R12-', 'research-tests/run-l2r12-')) and not path.endswith('.idr'))
