...
Accept lane-owned L2R15 non-Idris artifacts ONLY. No predecessor documentary or source repair is authorized.
Usage: python3 -I research-tests/run-l2r15-artifact-commit.py UNIT MESSAGE PATH...
"""
...
repair_checks = []
for path in paths:
 assert path in REPAIRS or path in DOCUMENTARY or (path.startswith(('research-tests/O6-L2R15-', 'research-tests/run-l2r15-')) and not path.endswith('.idr'))
