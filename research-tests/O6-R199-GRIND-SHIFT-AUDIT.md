# R199 main-lane grind-shift audit

## Baseline and limits

Exact starting HEAD fdf96f9a3af849263f2d5ce58693aa1dba89a46d on
cp5-thm73-scoping; tracked clean, only permitted paper/ and
review-o6-body-adversarial.md untracked. Idris2 v0.8.0. R198 audit read FIRST,
then R197/R196/R195/R194/R193/R192 audits and R190 design. No full-paper-reread
attestation at this checkpoint. Conservative start11:06Z Sep9; timeout15:06Z;
new-proof cutoff14:26Z; validation-start cutoff14:41Z; gate14:51Z.

A<=26, B<=18, C<=3 only after producer-owned A/B, D<=4. One new declaration per
native invocation, <=3 attempts per micro-unit, fresh authenticated guarded
commit or full revert/audit/gate. No source/production/frozen/lane2 changes
outside the authorized research scope. No new hole/unsafe escape/partial/with/
let/prefix; zero-hidden signatures and direct defining imports apply.

R198 detached Python -I guards adapted without exemptions. Source snapshots,
raw transcript, own-target Building requirement, extra-Building rejection,
target-mutation interruption and sampled RSS retained. All checks conservatively
acquire the shared heavy lock, including unknown costs;48GiB except frozen
LocalDiamond52GiB. UniqueOrdinal48GiB explicitly gated by task with measured
42.7GiB. Wait<=20min; stale>25min AND dead owner required for logged removal.
No lane2 worktree operations, main-only compiler scope, no seed deletion/cold
build. Production==34b21c9; all named frozen baselines remain binding.

## Initial check

S0-1 fresh seeded modulo-goal module PASS3.146s, sampled3,008,688KiB, exactly
its own81/81 Building line; no resource stop/mutation/extra Building. Guard
bootstrap is artifact-only and does not claim a synchronization producer.

## Status

A universal modulo synchronization, B present-vestigial disappearance and
