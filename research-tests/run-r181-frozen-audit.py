#!/usr/bin/env python3
"""Read-only R181 source/cache/census gate; never compiles or deletes seeds."""
import datetime
import hashlib
import json
import pathlib
...
# All five original spike files remain frozen in this first R181 gate.
for part in PARTS:
...
out = pathlib.Path(sys.argv[1] if len(sys.argv)>1 else '/tmp/dgamma-r181/frozen.json')
