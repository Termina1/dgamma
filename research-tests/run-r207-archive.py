...
from r207_common import ROOT,OUT,sha,write_json,utc
...
for p in sorted((ROOT/'research-tests').glob('*r207*.py')):files['tools/'+p.name]=p.read_bytes()
for name in ['r205_common.py','O6-R205-POST-FROZEN-BASELINE.json','O6-R206-OWNER-FINAL-GATE.md','O6-R206-O19-EXPANSION-DESIGN.md','O6-R207-CROSSTRACE-NEEDS.json','O6-R207-IMPORT-AUDIT.json','O6-R207-SEMANTIC-GATE.md','O6-R207-R208-RESIDUES.md','O6-R207-BLOCK-RESOLVER-NEEDS.json','O6-R207-SHIFT-DISPOSITIONS.md']:
