#!/usr/bin/env python3
"""Read-only R194 source/cache/census gate; never compiles or deletes seeds."""
import datetime
import hashlib
import json
import pathlib
...
# No LocalDiamond visibility change in R194; seeded TTC retained without deletion.
...
out = pathlib.Path(sys.argv[1] if len(sys.argv)>1 else '/tmp/dgamma-r194/frozen.json')
